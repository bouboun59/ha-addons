...
'''
_MQTT_ip = 'core.mosquitto'                  # Adresse IP du broker mqtt
...
_MQTT_TOPIC_SUB = 'Maestro/Command''              # Topic général de souscription
_MQTT_TOPIC_PUB = 'Maestro/State''              # Topic général de publication
